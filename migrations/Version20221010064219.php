 ...
 */
final class Version20221010064219 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book (id INT AUTO_INCREMENT NOT NULL, isbn VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, abstract LONGTEXT DEFAULT NULL, number_of_pages INT NOT NULL, date_pabulished DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
